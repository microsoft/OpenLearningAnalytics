...
sed "s/storage_account = '.*'/storage_account = '$OLA_STORAGE_ACCOUNT'/" $this_file_path/notebooks/Contoso_SIS_setup_and_update.ipynb > $this_file_path/../../tmp/Contoso_SIS_setup_and_update.ipynb
