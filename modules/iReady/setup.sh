...
sed "s/storage_account = '.*'/storage_account = '$OLA_STORAGE_ACCOUNT'/" $this_file_path/notebooks/iReady_setup_and_update.ipynb > $this_file_path/../../tmp/iReady_setup_and_update.ipynb
