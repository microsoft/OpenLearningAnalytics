...
sed "s/storage_account = '.*'/storage_account = '$OLA_STORAGE_ACCOUNT'/" $this_file_path/notebooks/M365_setup_and_update.ipynb > $this_file_path/../../tmp/M365_setup_and_update.ipynb
